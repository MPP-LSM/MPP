...
#include "finclude/petscviewer.h"
  ...
  type, public, extends(goveqn_base_type) :: goveqn_thermal_ksp_temp_soil_type
   ...
   contains
     ...
     procedure, public :: GetConditionNames       => ThermKSPTempSoilGetConditionNames
     procedure, public :: GetNumCellsInConditions => ThermKSPTempSoilGetNumCellsInConditions
...
contains
  ...
  !------------------------------------------------------------------------
  subroutine ThermKSPTempSoilGetConditionNames(this, cond_type, &
  ...
  end subroutine ThermKSPTempSoilGetConditionNames

  !------------------------------------------------------------------------
  subroutine ThermKSPTempSoilGetNumConditions(this, cond_type, &
  ...
  end subroutine ThermKSPTempSoilGetNumConditions

  !------------------------------------------------------------------------
  subroutine ThermKSPTempSoilGetNumCellsInConditions(this, cond_type, &
  ...
  end subroutine ThermKSPTempSoilGetNumCellsInConditions
