...
!          aux_vars_in(ghosted_id)%pressure_prev        = press_initial
  ...
  subroutine setup_petsc_snes()
    ...
    use SystemOfEquationsTHType          , only : SOETHSetAuxVars
    ...
    PetscInt :: igoveqn
    DM                                                :: dm_mass_s                ! DM object for soil mass equation
    DM                                                :: dm_mass_r                ! DM object for root mass equation
    DM                                                :: dm_mass_x                ! DM object for xylem mass equation
    DM                                                :: dm_eneg_s                ! DM object for soil energy equation
    DM                                                :: dm_eneg_r                ! DM object for root energy equation
    DM                                                :: dm_eneg_x                ! DM object for xylem energy equation
    PetscErrorCode                                    :: ierr
    class(goveqn_base_type),pointer                   :: cur_goveq
    ...
    select case(th_mpp%id)
    case (MPP_TH_SNES_CLM)
